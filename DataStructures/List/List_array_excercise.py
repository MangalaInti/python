Problem Statement
Here is a code that implements the look up functionality of an Organization's Directory. Go through the code and observe how the results are populated in a list. 
