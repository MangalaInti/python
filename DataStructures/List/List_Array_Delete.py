...
Problem Statement
Extend the code given in the code pane to delete Salt at index position 1. Use list.pop(index position) function wherever necessary.
...
# Deleting "Salt" at index position 1
marias_lst.pop(1)
print("List after deleting Salt at index position 1:")
print(marias_lst)
print("List details:")
list_details(marias_lst)
